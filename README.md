...
<picture>
  ...
  <img alt="Bar chart of quoted-printable encoding speed: zoomascii.b2a_qp 4,310 encodes per second, binascii.b2a_qp 299, pure-Python quopri 6.3" src="docs/benchmarks/b2a_qp.svg" width="720">
</picture>
...
(best of three runs pinned to one core, Python 3.11, September 2026).
